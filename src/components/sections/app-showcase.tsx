  ...
  return (
    <main className="flex justify-center mt-8 mb-20">
      {/* 
        ...
        - mt-8 mb-20: Corresponds to margin-top: 32px and margin-bottom: 80px from computed styles.
      */}
      <div className="relative w-[280px] h-[580px] p-[10px] bg-[#222222] rounded-[40px] shadow-[0_20px_50px_0_rgba(0,0,0,0.2)]">
        {/* 
        ...
        */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[100px] h-[25px] bg-[#222222] rounded-b-[15px] z-10" />
        {/* 
        ...
        */}
        <div className="relative h-full w-full overflow-hidden rounded-[30px] bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
          {/* 
          ...
          */}
          <div className="text-white text-center p-8">
            <h3 className="text-xl font-bold mb-4">PetMind</h3>
